...
public class Test中文编码 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //单字节 读取文件
        FileInputStream fis1 = new FileInputStream("A1_Java基础SE\\src\\基础知识\\IO流\\字符流\\字符流概述\\文件.txt");
        int by;
        ...
        //byte数组 读取文件
        FileInputStream fis2 = new FileInputStream("A1_Java基础SE\\src\\基础知识\\IO流\\字符流\\字符流概述\\文件.txt");
