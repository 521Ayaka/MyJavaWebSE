...
public class TestFileInputStream {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //创建字节输入流对象
        FileInputStream input1 = new FileInputStream("A1_Java基础SE\\src\\基础知识\\IO流\\字节流\\字节流读数据\\测试文件1.txt");
        ...
        * */
        ...
        //创建字节输入流对象
        FileInputStream input2 = new FileInputStream("A1_Java基础SE\\src\\基础知识\\IO流\\字节流\\字节流读数据\\测试文件1.txt");
        ...
        //创建字节输入流对象
        FileInputStream input3 = new FileInputStream("A1_Java基础SE\\src\\基础知识\\IO流\\字节流\\字节流读数据\\测试文件2.txt");
        ...
        */
        ...
        try{
            fileInput =  new FileInputStream("A1_Java基础SE\\src\\基础知识\\IO流\\字节流\\字节流读数据\\测试文件2.txt");
            //读取数据
