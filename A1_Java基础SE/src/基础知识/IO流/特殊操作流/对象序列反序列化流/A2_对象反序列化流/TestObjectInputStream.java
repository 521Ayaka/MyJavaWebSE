package 基础知识.IO流.特殊操作流.对象序列反序列化流.A2_对象反序列化流;
/*
...
import 基础知识.IO流.特殊操作流.对象序列反序列化流.A1_对象序列化流.Student2;
...
public class TestObjectInputStream {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream("A1_Java基础SE\\src\\基础知识\\IO流\\特殊操作流\\对象序列反序列化流\\A1_对象序列化流\\对象序列化.txt"));
