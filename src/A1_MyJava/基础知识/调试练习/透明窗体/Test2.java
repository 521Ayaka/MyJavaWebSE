package A1_MyJava.基础知识.调试练习.透明窗体;

//icon.setImage(icon.getImage().getScaledInstance(392,400,Image.SCALE_DEFAULT)); //图片大小
...
//        BufferedImage bi3 = waterMarkByText("测试aB~,");
        try {
            ImageIO.write(bi1, "png", new File("D:\\源代码\\img\\城市天空屋.jpg"));//写入文件
