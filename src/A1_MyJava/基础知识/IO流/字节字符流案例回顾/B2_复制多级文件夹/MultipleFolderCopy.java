package A1_MyJava.基础知识.IO流.字节字符流案例回顾.B2_复制多级文件夹;
...
public class MultipleFolderCopy {
    ...
    public static void main(String[] args) {
        ...
        //创建源文件地址
        File fileYuan = new File("src\\A1_MyJava\\基础知识\\IO流\\字节字符流案例回顾\\B2_复制多级文件夹\\源文件夹");
        //创建目的文件地址
        File fileNew = new File("src\\A1_MyJava\\基础知识\\IO流\\字节字符流案例回顾\\B2_复制多级文件夹\\目的文件");
