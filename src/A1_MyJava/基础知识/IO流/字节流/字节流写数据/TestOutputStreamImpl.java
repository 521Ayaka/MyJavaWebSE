...
public class TestOutputStreamImpl {
    ...
    public static void main(String[] args) throws IOException /*throws FileNotFoundException*/ {
        ...
        FileOutputStream outputStream = new FileOutputStream("D:\\源代码\\src\\A1_MyJava\\基础知识\\IO流\\字节流\\字节流写数据\\测试文件1.txt");
        ...
        */
        //参数为true
        FileOutputStream fos = new FileOutputStream("D:\\源代码\\src\\A1_MyJava\\基础知识\\IO流\\字节流\\字节流写数据\\测试文件2.txt",true);
