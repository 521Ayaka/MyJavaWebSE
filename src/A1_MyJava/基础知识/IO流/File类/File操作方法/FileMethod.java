package A1_MyJava.基础知识.IO流.File类.File操作方法;
...
public class FileMethod {
    ...
    public static void main(String[] args) {
        //创建File抽象路径
        //文件夹 测试文件包
        File file1 = new File("D:\\源代码\\src\\A1_MyJava\\基础知识\\IO流\\File类\\File操作方法\\测试文件包");
        //文件  文件1.txt
        File file2 = new File("D:\\源代码\\src\\A1_MyJava\\基础知识\\IO流\\File类\\File操作方法\\测试文件包\\文件1.txt");
        //不存在的文件 文件3.txt
        File file3 = new File("D:\\源代码\\src\\A1_MyJava\\基础知识\\IO流\\File类\\File操作方法\\测试文件包\\文件3.txt");
        //非绝对路径，直接封装
