package A1_MyJava.基础知识.IO流.字符流.字符流_编码解码.字符流类Method;
...
public class TestInputStreamReader_Method {
    ...
    public static void main(String[] args) throws IOException {
        ...
        InputStreamReader isr1 = new InputStreamReader(new FileInputStream("src\\A1_MyJava\\基础知识\\IO流\\字符流\\字符流_编码解码\\字符流类Method\\文件1.txt"));
        int by;
        ...
        InputStreamReader isr2 = new InputStreamReader(new FileInputStream("src\\A1_MyJava\\基础知识\\IO流\\字符流\\字符流_编码解码\\字符流类Method\\文件1.txt"));
