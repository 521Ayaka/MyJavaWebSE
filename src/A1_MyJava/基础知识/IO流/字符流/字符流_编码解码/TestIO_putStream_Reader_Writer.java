package A1_MyJava.基础知识.IO流.字符流.字符流_编码解码;
/*
...
public class TestIO_putStream_Reader_Writer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        */
        //先创建一个字节流输出对象
        FileOutputStream fos = new /*别忘了异常处理*/ FileOutputStream("D:\\源代码\\src\\A1_MyJava\\基础知识\\IO流\\字符流\\字符流_编码解码\\文件1.txt");
        ...
        try{//try...catch...finally异常环绕处理方式 处理异常
            ...
            oswNew = new OutputStreamWriter(
                     new FileOutputStream
                         ("src\\A1_MyJava\\基础知识\\IO流\\字符流\\字符流_编码解码\\文件2.txt",true/*追加写入*/)
            ...
            */
            ...
            isr = new InputStreamReader(
                  new FileInputStream
                      ("src\\A1_MyJava\\基础知识\\IO流\\字符流\\字符流_编码解码\\文件2.txt"));
            //读数据
            int by;//使用单个字符读
            while((by = isr.read()) != -1){
    ...
    public static void method(){
        ...
        try{//try...catch...finally异常环绕处理方式 处理异常
            ...
            osw = new OutputStreamWriter(new FileOutputStream("src\\A1_MyJava\\基础知识\\IO流\\字符流\\字符流_编码解码\\文件1.txt",true));
            //写入数据
