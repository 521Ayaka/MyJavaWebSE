...
![网络编程](https://gitee.com/embarrassing-sauce/my-code/raw/master/img/MDimg/网络编程.png)
...
![IP](https://gitee.com/embarrassing-sauce/my-code/raw/master/img/MDimg/IP.png)
...
![网络通信](https://gitee.com/embarrassing-sauce/my-code/raw/master/img/MDimg/网络通信.png)
...
![TestUDP_01发送数据](https://gitee.com/embarrassing-sauce/my-code/raw/master/img/MDimg/TestUDP_01发送数据.png)
...
![TestUDP_02接收数据](https://gitee.com/embarrassing-sauce/my-code/raw/master/img/MDimg/TestUDP_02接收数据.png)
...
![TCP通信原理](https://gitee.com/embarrassing-sauce/my-code/raw/master/img/MDimg/TCP通信原理.png)
...
![img](https://gitee.com/embarrassing-sauce/my-code/raw/master/img/MDimg/img-16348083717401.png)
    ...
    public void run() {
        ...
        try (   BufferedReader br = new BufferedReader(new InputStreamReader(s.getInputStream()));
                BufferedWriter bw =
                        new BufferedWriter(
                        new FileWriter(
                        new File("src\\A1_MyJava\\基础知识\\网络编程\\网络通信\\TCP协议\\TCP通信服务端口多线程\\服务器接收文件\\"+Thread.currentThread().getName()+".txt")));
                BufferedWriter bwx = new BufferedWriter(new OutputStreamWriter(s.getOutputStream()));
                ){
...
### [网络编程基础.md](https://gitee.com/embarrassing-sauce/my-code/blob/master/src/A1_MyJava/基础知识/网络编程/网络编程基础总复习.md)
